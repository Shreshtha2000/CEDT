                            ...
                            if (window["WebSocket"]) {
                                ...
                                try {
                                    ...
                                    socket.on('mcowpd', function(msg) {
                                        let num = parseFloat(msg.message);
                                        document.getElementById("distance-to-wp").innerHTML = num.toFixed(2);
                                    });
                                    socket.on('gpsialt', function(msg) {
                                        let num = parseFloat(msg.message);
                                        document.getElementById("altitude").innerHTML = (num / 1000).toFixed(2);
                                    });
                                    socket.on('gpsivz', function(msg) {
                                        let num = parseFloat(msg.message);
                                        document.getElementById("vertical-speed").innerHTML = num.toFixed(2);
                                    });
                                    socket.on('vfrhgs', function(msg) {
                                        let num = parseFloat(msg.message);
                                        document.getElementById("GroundSpeed").innerHTML = num.toFixed(2);
                                    });
                                    socket.on('mode', function(msg) {
                                        let num = msg.message;
                                        document.getElementById("fmode").innerHTML = num;
                                    });
